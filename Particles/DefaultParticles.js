...
export function SendParticleSystemData()
{
    return new ParticleSystemData(
        ...
        new Vector2(RandomRange(1, 20), RandomRange(1, 15)), // Spawn pos => Wo die Partikel Erscheinen
        new Vector2(20, 17), //Sprite => Welcher Sprite vom Spritesheet gewählt werden soll
